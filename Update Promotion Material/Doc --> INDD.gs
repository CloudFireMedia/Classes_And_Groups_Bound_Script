...
function ChooseSettingsFile() {
	var app = DocumentApp,
		...
		result = ui.prompt(
			...
			"Please enter url of settings file. Sheet must be named 'Classroom Signage Quantities'. \n\nThe default URL is: \n\nhttps://docs.google.com/spreadsheets/d/1RJQIoutRVmGsN6_P4W_FD9NCHjZKztlVo-zaQ-QLDVI/edit?pli=1#gid=0",
...
function ConvertToJson(settings) {
	var app = DocumentApp,
		...
		filename = 'IMPORT ' + doc.getName().split('\\.')[0] + '.json', 
		data = {},
		result = {},
	...
	ui.alert('File \"' + file.getName() + '\" has been saved in your Google Drive home folder.');
}